...
$('.js-tabs li a').on('click', function () {
  $(this).parents('.js-tab-wrap').find('.js-tab-cont').addClass('hide')
  ...
  if ($(window).width() <= 767) {
    $(this).parent().parent('.js-tabs').fadeOut(600)
  } else {
    $(this).parent().parent('.js-tabs').css('display', 'block')
  }
  return false
})
...
if ($('.number-popup__number').length) {
  $('.number-popup__number').mask('+7 (999) 999-99-99')
};

if ($('.drop-payment-popup__number').length) {
  $('.drop-payment-popup__number').mask('+7 (999) 999-99-99')
};

if ($('#creditcard-number').length) {
  $('#creditcard-number').mask('+7 (999) 999-99-99')
};

if ($('.js-sertificate-input').length) {
  $('.js-sertificate-input').mask('9999 - 9999 - 9999 - 9999')
};
...
if ($('.js-cab-item-exit').length) {
  $('.js-cab-item-exit').on('click', function () {
    if ($(window).width() <= 767) {
      $(this).parent().parent('.js-tab-cont').addClass('hide')
      var next = $(this).parents('.js-tab-wrap').find('.js-tabs').fadeIn(600)
      console.log(next)
    }
  })
}
